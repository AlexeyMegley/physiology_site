...
class TestModels(TestCase):
    ...
    def test_points_by_subjects(self):
        ...
        self.assertTrue(self.student1.total_score == 0, "Student total score is not equal to zero")
        ...
        self.assertTrue(self.student1.total_score > 0, "Student score wasn't increased")
    ...
    def test_global_rank(self):
        ...
        self.assertTrue(rank2 < rank1, "Rank2 expected 1, actual {}. Rank1 expected 2, actual {}".format(rank2, rank1))
    ...
    def test_subject_rank(self):
        ...
        self.assertTrue(rank1 == rank2, '''Rank1 - expected 1, actual {}. Rank2 - expected 1, actual {}'''.format(rank1, rank2))
    ...
    def test_tracked_students(self):
        ...
        self.assertTrue(all(filter(lambda stud: stud in self.teacher.tracked_students(), (self.student1, self.student2))), \
    ...
    def test_uni_total_score(self):
        ...
        self.assertTrue(self.uni1.total_score() == self.student1.total_score, "Score uni1 != score student1")
        self.assertTrue(self.uni2.total_score() == self.student2.total_score, "Score uni2 != score student2")

    def test_uni_global_rank(self):
        # Check that global ranks of the universities are equal to the global ranks of the students
        self.assertTrue(self.uni1.global_rank() == self.student1.global_rank(), "Rank uni1 != rank student1")
        self.assertTrue(self.uni2.global_rank() == self.student2.global_rank(), "Rank uni2 != rank student2")        

    def test_group_total_score(self):
        # Check that global ranks of the groups are equal to the global ranks of the students
        self.assertTrue(self.group1.total_score() == self.student1.total_score, "Score group1 != score student1")
        self.assertTrue(self.group2.total_score() == self.student2.total_score, "Score group2 != score student2")
    ...
    def test_group_global_rank(self):
        ...
        self.assertTrue(self.group1.global_rank() == 1, "Rank of the group1 is not equal to 1")
        self.assertTrue(self.group2.global_rank() == 1, "Rank of the group1 is not equal to 1")
    ...
    def test_comments(self):
        ...
        self.assertTrue(self.comment2 in self.comment1.childs(), "{} not in {}".format(self.comment2, self.comment1.childs()))

        # Check that it's related to the parent
        self.assertTrue(self.comment2.is_related(self.comment1), "Comment2 is not related to it's parent")

        # Check that 2nd and 3rd are related with each other
        self.assertTrue(self.comment2.is_related(self.comment3), "Comment2 is not related to it's brother")
